...
AppBar _inicialBar = AppBar(title: Text('Categorias'));

bool multiselecionado = false;

List<Widget> escolheAcoes() {
  List<Widget> acoes = multiselecionado
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: selecaoAtivada
          ? AppBar(actions: escolheAcoes(), backgroundColor: Colors.teal)
          : _inicialBar,
