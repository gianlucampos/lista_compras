...
class CustomReordableListView extends StatefulWidget {
  @override
  _CustomReordableListViewState createState() =>
      _CustomReordableListViewState();
}

class _CustomReordableListViewState extends State<CustomReordableListView> {
  double padValue = 0;
